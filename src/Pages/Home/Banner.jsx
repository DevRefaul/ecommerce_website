  ...
  return (
    <>
      <section className="my-8 grid grid-cols-1 gap-8 xl:grid-cols-[3fr,1fr]">
        ...
        {/* second section */}
        <div className=" border border-gray-600 p-2 rounded-xl h-auto grid grid-cols-1 md:grid-cols-2 gap-4 xl:grid-cols-1">
          {/* 1st card */}
          <div class="xl:mb-3 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="/">
              <img
          ...
          {/* 2nd card */}
          <div class="xl:mt-3 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="/">
              <img
                class="p-8 rounded-t-lg"
                src="https://flowbite.com/docs/images/products/apple-watch.png"
