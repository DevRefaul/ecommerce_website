    ...
    <>
      <section className="my-8">
        <Swiper
          ...
          loop={true}
          autoplay={{ delay: 3000 }}
          className="mySwiper rounded-xl h-[70vh]"
        >
...
export default Banner;
        ...
        // }
        // {
        //   /* <section className=" border border-gray-600 p-2 rounded-xl xl:h-[50vh] ">
        ...
        //           <span className="text-3xl font-semibold text-red-700 dark:text-white">
        //             $599
        //           </span>
        //           <a
        //             href="/"
        //             className="text-white bg-red-600 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-500 dark:focus:ring-red-800"
        //           >
        //             Buy
        //           </a>
        //         </div>
