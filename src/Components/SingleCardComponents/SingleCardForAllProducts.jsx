      ...
      <div className="max-w-sm h-full singleCard">
        ...
        >
          <div className="flex flex-col justify-between">
            ...
            {/* section for btns */}
            <div id="bottomBtns" className="grid xl:grid-cols-2 gap-2">
              <Link
                to={`/products/${category}/${name}`}
                state={{ productName: name, productId: _id }}
              >
                <button className="seeMore text-sm py-2.5 text-center mr-2 mb-2 mt-6 xl:mt-4 w-full">
                  See More
                </button>
              </Link>
              <button
                className="addToCart text-sm p-0 text-center ml-2 mb-2 xl:mt-4 w-full"
                onClick={() =>
